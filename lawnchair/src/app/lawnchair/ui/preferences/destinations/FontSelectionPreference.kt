...
fun FontSelection(
    ...
    val items by produceState(initialValue = emptyList<FontCache.Family>()) {
        ...
        val googleSansVariants = HashMap<String, FontCache.Font>()
        googleSansVariants["regular"] = FontCache.ResourceFont(context, R.font.google_sans, "Google Sans " + context.getString(R.string.font_weight_regular))
        googleSansVariants["500"] = FontCache.ResourceFont(context, R.font.google_sans_medium, "Google Sans " + context.getString(R.string.font_weight_medium))
        googleSansVariants["600"] = FontCache.ResourceFont(context, R.font.google_sans_semi_bold, "Google Sans " + context.getString(R.string.font_weight_semi_bold))
        googleSansVariants["700"] = FontCache.ResourceFont(context, R.font.google_sans_bold, "Google Sans " + context.getString(R.string.font_weight_bold))
        list.add(FontCache.Family("Google Sans", googleSansVariants))
